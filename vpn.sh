...
function installQuestions() {
	...
	echo "The git repository is available at: https://github.com/vpn420/vpn"
	echo ""
	...
	until [[ $IPV6_SUPPORT =~ (y|n) ]]; do
		read -rp "Do you want to enable IPv6 support (NAT)? [y/n]: " -e -i n IPV6_SUPPORT
	done
	echo ""
	...
	echo "See https://github.com/vpn420/vpn#security-and-encryption to learn more."
	echo ""
	...
	if [[ $CUSTOMIZE_ENC == "n" ]]; then
		...
		2)
			...
			until [[ $DH_KEY_SIZE_CHOICE =~ ^[1-3]$ ]]; do
				read -rp "DH key size [1-3]: " -e -i 3 DH_KEY_SIZE_CHOICE
			done
